...
<head><!--260x355 current min size-->
	...
	<style>body{font-family:Arial, sans-serif;}.a{width:200px;float:left;margin-bottom:5px;margin-top:5px;}</style>
	<style>
    ...
    border-radius: 0;
    min-height: 35px;}
    body{ background:#eee url(modal-gloss.png) no-repeat -200px -80px; }
	</style>
